  ...
  <div class="map-container">
    <div id="container">
      <div class="map-controls">
        ...
        <button @click="loadVectorData('http://10.181.24.94:5000/shapefile-to-geojson')">加载矢量数据</button>
        <button @click="loadTiffImage('http://10.181.24.94:5000/tif-to-image')">加载TIF影像</button>
      </div>
    </div>
  </div>
</template>
